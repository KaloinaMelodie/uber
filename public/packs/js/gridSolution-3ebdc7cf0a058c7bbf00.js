...
(function () {
  ...
  function init() {
    ...
    var dx1 = document.getElementById('departx').value; //dx1=2;

    var dy1 = document.getElementById('departy').value; //dy1=1.5;
    ...
    for (var _i2 = 0; _i2 < points.length - 1; _i2++) {
      if (points[_i2][0] <= dx1 && dx1 <= points[_i2 + 1][0] && points[_i2][1] <= dx1 && dx1 <= points[_i2 + 1][1]) {
        e = _i2 - 2;
      }
    }
...
/******/ });
//# sourceMappingURL=gridSolution-3ebdc7cf0a058c7bbf00.js.map