...
(function () {
  ...
  function init() {
    ...
    var dx1 = parseInt(document.getElementById('departx').value); //dx1=2.5;

    var dy1 = parseInt(document.getElementById('departy').value); //dy1=2;
    ...
    document.getElementById('go').onclick = function () {
      vita = false;
      console.log(e);
      var depart = parseInt(points[e]);
      var arrive = parseInt(points[e + 1]);
      dx = depart[0];
      dy = depart[1];
...
/******/ });
//# sourceMappingURL=gridSolution-f049cbfe91b72276d7a1.js.map